 ...
 * The root app/layout.tsx handles the HTML shell (fonts, analytics) and applies
 * to ALL pages — including the dashboard. The Footer belongs only on marketing
 * pages, so it lives here inside the (marketing) route group instead of in the
 * root layout.
 *
